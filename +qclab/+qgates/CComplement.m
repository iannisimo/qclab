...
% ==============================================================================
classdef CComplement < qclab.qgates.QControlledGate2

  properties (Access = protected)
    %> Property storing the 1-qubit Pauli-Y gate of this 2-qubit controlled gate.
    gate_(1,1)  qclab.qgates.Complement
  end
  ...
  methods
    ...
    %>        default = 1
    % ==========================================================================
    function obj = CComplement(control, target, controlState)
      % set defaults
      ...
      obj.gate_ = qclab.qgates.Complement( target );
    ...
    function [bool] = equals(obj, other)
      bool = false;
      if isa(other,'qclab.qgates.CComplement') && ...
